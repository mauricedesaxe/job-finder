/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0413ef6a395c855957a75f2f6e91a40b)
...
interface __BaseEnv_Env {
	...
	JOB_FINDER: DurableObjectNamespace<import("./src/cloudflare").JobFinderContainer>;
	JOB_FINDER_WORKFLOW: Workflow<Parameters<import("./src/cloudflare").JobFinderWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cloudflare");
		durableNamespaces: "JobFinderContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENABLE_ATS_ENRICHMENT">> {}
}
